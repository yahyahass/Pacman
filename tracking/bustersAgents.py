...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        bestAction = None
        for ghostPosition in (max(belief, key=belief.get) for belief in livingGhostPositionDistributions):
            for action in legal:
                distance = self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, action), ghostPosition)
